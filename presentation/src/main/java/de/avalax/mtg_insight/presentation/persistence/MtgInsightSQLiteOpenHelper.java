...
public class MtgInsightSQLiteOpenHelper extends SQLiteOpenHelper {
    private Context context;
    private int createRessourceId;

    public MtgInsightSQLiteOpenHelper(String name, int version, Context context, int createRessourceId) {
